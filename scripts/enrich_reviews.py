...
def derive_pain(company: str, reviews: list[str], key: str) -> str:
    ...
    prompt = (
        ...
        "hard to book, long wait). Return JSON: {\"pain\": \"<ONE short Arabic sentence usable "
        "as an email opener referencing what customers say, e.g. 'لاحظت أن بعض مراجعيكم ذكروا "
        "تأخّر الردّ على اتصالاتهم'\"}. If the reviews show no such pain, return {\"pain\": \"\"}. "
        "Do NOT invent anything the reviews don't say."
    )
